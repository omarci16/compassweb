...
export type LeadSource =
  ...
  | "cold_outreach"
  | "inbound_form"
  // The site's five-step contact brief. Kept distinct from inbound_form
  // because these leads carry a populated `brief` column — bottleneck,
  // response speed, tools, budget — and qualify far harder as a result.
  | "contact_brief"
  | "other";
